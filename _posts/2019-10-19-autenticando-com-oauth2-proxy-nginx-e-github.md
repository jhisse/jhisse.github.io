...
![Client ID and Client Secret](/images/2019-10-19-autenticando-com-oauth2-proxy-nginx-e-github/application_created.png)
...
![Tela de login](/images/2019-10-19-autenticando-com-oauth2-proxy-nginx-e-github/sign_in_oauth.png)

Ao clicar em "**Sign in with Github**" iremos para a página de autorização da aplicação.

![Tela de autorização](/images/2019-10-19-autenticando-com-oauth2-proxy-nginx-e-github/authorize_screen.png)

Em seguida iremos ser redirecionados de volta ao nosso website e nosso backend tendo autorizado a autenticação.

![Website](/images/2019-10-19-autenticando-com-oauth2-proxy-nginx-e-github/html_screen.png)
...
![403 Permission Denied](/images/2019-10-19-autenticando-com-oauth2-proxy-nginx-e-github/permission_denied.png)
