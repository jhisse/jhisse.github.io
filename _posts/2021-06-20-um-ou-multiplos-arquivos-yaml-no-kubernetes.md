...
Para seu ambiente local vamos utilizar o [Kind](https://kind.sigs.k8s.io/), já citado no artigo em que falamos sobre [pods anti affinity]({% post_url 2021-04-03-aumentando-disponibilidade-com-inter-pod-anti-affinity %}). Iremos precisar também do [kubectl](https://kubernetes.io/docs/tasks/tools/#kubectl) para gerenciar nosso cluster.
